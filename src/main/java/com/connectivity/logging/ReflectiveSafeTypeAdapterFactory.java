...
/**
 * From gson#ReflectiveTypeAdapterFactory, modified copy for skipping bound fields throwing errors. (E.g. records with added fields without getters, via coremodding)
...
public final class ReflectiveSafeTypeAdapterFactory
{
    ...
    public static <T> TypeAdapter<T> createNew(Gson gson, final TypeToken<T> type)
    {
        try
        {
            ...
            return new FieldReflectionAdapter<>(getBoundFields(gson, type, raw, blockInaccessible, false));
        }
        catch (Throwable t)
        {
    ...
    private static BoundField createBoundField(
        ...
        final boolean blockInaccessible)
    {
        ...
        @SuppressWarnings("unchecked") final TypeAdapter<Object> typeAdapter = (TypeAdapter<Object>) mapped;
        return new BoundField(name, field, serialize, deserialize)
        {
                ...
                throws IOException, IllegalAccessException
            {
                ...
                writer.name(name);
                Type runtimeType = getRuntimeTypeIfMoreSpecific(fieldType.getType(), fieldValue);
                TypeAdapter<Object> runtimeTypeAdapter = (TypeAdapter<Object>) context.getAdapter(TypeToken.get(runtimeType));
    ...
    private static Map<String, BoundField> getBoundFields(
